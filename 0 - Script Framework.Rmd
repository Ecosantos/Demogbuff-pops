...
```{r, label="Figure 2", fig.height=8, fig.width=16, message=FALSE, warning=FALSE}
cowplot::plot_grid(
...
```{r label="Figure 4", dev=c('png','svg'), fig.height=16, fig.width=8}
...
# TESTING EFFECT OF TIMESERIE LENGTH ON BUFFERING QUANTIFICATION
