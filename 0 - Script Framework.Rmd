...
-   $L$ : reproductive window
-   $L_a$: mean age at first reproduction
-   $L_a prop$
-   $e$
-   $D$
-   Growth ($\gamma$): individual development
-   $H$
-   
...
<!--# LETRAS NA TABELA E NO SCRIPT ESTÂO ERRADAS NO SENTIDO DE QUE NÃO REFLETEM BEM A NOMECLATURA COMUMENTE UTILIZADA. VERIFICAR SE ISSO PRECISA SER REVISADO EM TODOS OS SCRIPTS OU APENAS NA TABELA FINAL JÁ RESOLVE -->
