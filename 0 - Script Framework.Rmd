...
mutate_if(is.numeric,abs)%>%  # Make sure valures are in their absolute form. (This is likely to be removed in next version because it is already done in the final dataset  but confirm before remove this line)
